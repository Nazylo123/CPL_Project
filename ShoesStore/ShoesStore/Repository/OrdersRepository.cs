    ...
    public class OrdersRepository : IOrdersRepository
    {
        ...
        public async Task<IEnumerable<OrderViewModel>> GetAllOrdersAsync()
        {
            return await _context.Orders
                ...
                .Select(o => new OrderViewModel
                {
                    ...
                    Status = o.Status,  // Sử dụng string status
        ...
        public async Task<OrderViewModel> GetOrderByIdAsync(int orderId)
        {
            ...
            return new OrderViewModel
            {
                ...
                Status = order.Status,  // Sử dụng string status
        ...
        public async Task AddOrderAsync(OrderViewModel orderViewModel)
        {
            var order = new Order
            {
                ...
                Status = orderViewModel.Status,  // Sử dụng string status
        ...
        public async Task UpdateOrderAsync(OrderViewModel orderViewModel)
        {
            ...
            if (order != null)
            {
                order.Status = orderViewModel.Status;  // Cập nhật status dưới dạng string
